...
Since the DARE solution provides a local Lyapunov approximation around the equilibrium for nonlinear systems and is not globally valid, 
...
it is questionable whether the policy remains reasonably close to the expert within the actual training domain $\mathcal{X}_V$.
...
Beyond verification, the co-training reveals a limitation of the single-step adversarial training sheme. 
